...
var I18N = {
  es: {
    ...
    mounted: "montado", unmounted: "presente", missing: "origen ausente",
    no_logs: "(sin registros aún)",
    clear_log: "Borrar registro", log_cleared: "Registro borrado",
    no_external_hint: "Conectá una SD u OTG para poder vincular una carpeta",
  ...
  "es-ES": {
    ...
    no_logs: "(sin registros aún)",
    clear_log: "Borrar registro", log_cleared: "Registro borrado",
    no_external_hint: "Conecta una SD u OTG para poder vincular una carpeta",
    saving: "Guardando y montando...", done: "Listo",
  ...
  en: {
    ...
    mounted: "mounted", unmounted: "available", missing: "source missing",
    no_logs: "(no logs yet)",
    clear_log: "Clear log", log_cleared: "Log cleared",
    no_external_hint: "Connect an SD card or OTG drive to link a folder",
